...
import ExamListUpdated from './components/exam/ExamListUpdated';
...
import QuestionBuilderUpdated from './components/admin/QuestionBuilderUpdated';
  ...
  return (
    <SimpleLayout>
      <Routes>
        ...
        <Route path="/" element={<ExamListUpdated />} />
