      ...
      <CardContent>
        ...
        {question.description !== undefined && (
          <div className="mb-4">
            <textarea
              ...
              className="w-full text-sm text-gray-600 bg-transparent border-none outline-none resize-none focus:bg-gray-50 p-2 rounded"
              rows={2}
              onClick={(e) => e.stopPropagation()}
            />
          </div>
        ...
        {(question.image || question.video) && (
          <div className="mb-4">
            ...
            {question.video && (
              <video src={question.video} controls className="max-w-full h-auto rounded" />
            )}
          </div>
        )}
        ...
        {question.type === 'linear-scale' && (
          <div className="space-y-3">
            <div className="flex items-center space-x-4">
              ...
              <select
                value={question.correctAnswer || '1-5'}
      ...
      <div className="space-y-4">
        ...
        {question.type === 'multiple-choice' || question.type === 'checkboxes' ? (
          <>
            ...
            <div className="flex items-center justify-between">
              <label className="text-sm font-medium text-gray-700">Allow "Other" Option</label>
              <input
                type="checkbox"
            ...
            {question.type === 'multiple-choice' && (
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-gray-700">Multiple Correct</label>
                <input
                  type="checkbox"
        ...
        <div className="flex items-center justify-between">
          <label className="text-sm font-medium text-gray-700">Partial Credit</label>
          <input
            type="checkbox"
            checked={question.settings.partialCredit}
            onChange={(e) => onUpdate({ 
              settings: { 
                ...question.settings, 
