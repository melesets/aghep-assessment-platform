...
CREATE POLICY "Allow all access to exam_attempts" ON public.exam_attempts FOR ALL USING (true);
CREATE POLICY "Allow all access to user_answers" ON public.user_answers FOR ALL USING (true);
CREATE POLICY "Allow all access to certificates" ON public.certificates FOR ALL USING (true);
